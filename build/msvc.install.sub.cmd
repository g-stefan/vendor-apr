...
xcopy /Y /S /E "temp\apr\bin\*.exe" "%INSTALL_PATH_BIN%\"
xcopy /Y /S /E "temp\apr\bin\*.dll" "%INSTALL_PATH_BIN%\"
...
xcopy /Y /S /E "temp\apr\bin\*.exe" "%INSTALL_PATH_DEV%\bin\"
xcopy /Y /S /E "temp\apr\bin\*.dll" "%INSTALL_PATH_DEV%\bin\"
xcopy /Y /S /E "temp\apr\include\" "%INSTALL_PATH_DEV%\include\"
copy /Y /B "temp\apr\lib\*.lib" "%INSTALL_PATH_DEV%\lib\*"
