...
call :cmdX xyo-cc --mode=%ACTION% --source-has-archive apr
...
SET CMD_CONFIG=%CMD_CONFIG% -DCMAKE_INSTALL_PREFIX=%WORKSPACE_PATH_BUILD%\apr
SET CMD_CONFIG=%CMD_CONFIG% -DAPR_INSTALL_PRIVATE_H=ON
